...
// May get used if there is time to add style to the CANbot

    import edu.wpi.first.wpilibj.DriverStation;
    import edu.wpi.first.wpilibj.motorcontrol.Spark;  // don't think sparks are being used on the bot
    import edu.wpi.first.wpilibj2.command.SubsystemBase;
    import frc.robot.Constants.LED;  // add constants 

public class SUB_LED extends SubsystemBase {
  private static SUB_LED INSTANCE = null;
  ...
  static Spark blinkin;
    ...
    public SUB_LED() {
      blinkin = new Spark(LED.kPWMPort);
    }
